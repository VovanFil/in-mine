...
$_['text_approval'] = '<p>Спасибо за регистрацию в %s!</p><p>Для активации аккаунта перейдите по ссылке, высланной вам по почте.</p><p>Если у Вас есть какие-то вопросы, пожалуйста <a href="%s">напишите нам</a>.</p>';
