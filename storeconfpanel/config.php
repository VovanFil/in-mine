<?php
// HTTP
define('HTTP_SERVER', 'http://localhost/storeconfpanel/');
define('HTTP_CATALOG', 'http://localhost/');

// HTTPS
define('HTTPS_SERVER', 'http://localhost/storeconfpanel/');
define('HTTPS_CATALOG', 'http://localhost/');

// DIR
define('DIR_APPLICATION', 'C:/OSPanel/domains/localhost/storeconfpanel/');
