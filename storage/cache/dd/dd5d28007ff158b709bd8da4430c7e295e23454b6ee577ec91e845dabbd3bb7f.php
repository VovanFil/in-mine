...
/* tt_lazio1/template/common/cart.twig */
class __TwigTemplate_6e9911df45efe1d238d8325b555bbdd5b0f707ab79331262ed4b289a68f27d6b extends Twig_Template
{
...
\t\t</p>      
    ...
    {
        return "tt_lazio1/template/common/cart.twig";
    }
    ...
    {
        return array (  196 => 52,  190 => 49,  187 => 48,  178 => 44,  172 => 43,  168 => 41,  159 => 38,  155 => 37,  152 => 36,  148 => 35,  142 => 31,  131 => 28,  127 => 27,  122 => 25,  118 => 23,  113 => 22,  102 => 19,  97 => 17,  92 => 16,  86 => 15,  81 => 14,  78 => 13,  69 => 12,  62 => 11,  56 => 10,  42 => 9,  39 => 8,  35 => 7,  31 => 5,  29 => 4,  22 => 2,  19 => 1,);
    }
}
/* <div id="cart" class="btn-group btn-block">*/
/*   <button type="button" data-toggle="dropdown" data-loading-text="{{ text_loading }}" class="btn dropdown-toggle dropdown-cart"><i class="ion-bag"></i> <span id="cart-total">{{ text_items }}</span></button>*/
/*   <ul class="dropdown-menu pull-right">*/
...
/* 		</td>          */
/*           <td class="text-center cart-close"><button type="button" onclick="cart.remove('{{ product.cart_id }}');" title="{{ button_remove }}" class="btn btn-danger btn-xs"><i class="fa fa-times-circle"></i></button></td>*/
/*         </tr>*/
/*         {% endfor %}*/
...
/*           <td class="text-center text-danger"><button type="button" onclick="voucher.remove('{{ voucher.key }}');" title="{{ button_remove }}" class="btn btn-danger btn-xs"><i class="fa fa-times-circle"></i></button></td>*/
/*         </tr>*/
/*         {% endfor %}*/
/*       </table>*/
/*     </li>*/
